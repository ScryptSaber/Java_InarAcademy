	...
	public static void main(String[] args) {
		...
		case 2:
			if (income <= 8350) {
				...
				tax = 8350 * 0.10 + (33950 - 16700) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
						+ (income - 104425) * 0.33;
			} else {
				tax = 8350 * 0.10 + (33950 - 16700) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
		...
		case 3:
			if (income <= 11950) {
				...
				tax = 11950 * 0.10 + (45500 - 16700) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28
						+ (income - 190200) * 0.33;
			} else {
				tax = 11950 * 0.10 + (45500 - 16700) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28
						+ (372951 - 190200) * 0.33 + (income - 372951) * 0.35;
			}break;
